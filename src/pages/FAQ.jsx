      ...
      questions: [
        {
          ...
          answer: 'Our investment opportunities are available to accredited investors who meet the qualification requirements defined by applicable securities regulations. Generally, this includes individuals with annual income exceeding $200,000 ($300,000 joint) for the past two years, or net worth exceeding $1 million excluding primary residence. Entity investors must meet similar threshold requirements.'
        },
        {
          question: 'What is the minimum investment amount?',
          answer: 'Minimum investment amounts vary by division: Sustainable & Emerging Markets requires $25,000 minimum; Luxury Automotive & Logistics requires $50,000 minimum; and Alternative Investments requires $100,000 minimum. We can discuss customized solutions for larger investment amounts across multiple divisions.'
        },
        {
          question: 'How do I get started?',
          answer: 'Begin by expressing your interest through our online form or contacting our team directly. We\'ll schedule a confidential consultation to discuss your investment objectives, review available opportunities, and explain our onboarding process. If you decide to proceed, we\'ll guide you through the qualification assessment, due diligence review, and KYC/AML compliance requirements.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Our process follows seven structured steps: (1) Initial Inquiry and consultation, (2) Qualification Assessment to verify accreditation status, (3) Due Diligence Review where you receive comprehensive investment materials, (4) KYC/AML Compliance verification, (5) Agreement Execution with electronic signature, (6) Capital Deployment to escrow account, and (7) Investor Portal Access for ongoing management and reporting.'
        },
        {
          question: 'What documents will I need to provide?',
          answer: 'You\'ll need to provide: government-issued photo identification (passport or driver\'s license), proof of address (utility bill or bank statement), accreditation verification (tax returns, CPA letter, or brokerage statement), and source of funds documentation. For entity investors, additional corporate documents including formation documents, beneficial ownership information, and board resolutions may be required.'
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'There are no upfront fees, placement fees, or subscription fees. You pay only the ongoing management fee and performance fee based on results. Third-party costs (legal review, wire transfers, etc.) are borne by investors but are minimal and disclosed in advance.'
        }
      ]
    },
    {
        ...
        <div className="faq-hero-content">
          <div className="faq-hero-text-container">
            ...
            <p className="faq-hero-description">
              ...
              capital protection framework, and investor requirements.
            </p>
      ...
      <section className="faq-content-section">
        <div className="faq-content">
          {filteredFAQs.length === 0 ? (
            <Card>
              <CardBody className="no-results-card">
                <p className="no-results-text">No questions found matching your search. Try different keywords or browse all categories.</p>
                <button 
                        ...
                        <Card key={questionIndex} className="faq-question-card">
                          ...
                          >
                            <div className="faq-question-header">
                              <h5 className="faq-question-title">{item.question}</h5>
                              <ChevronDown 
      ...
      <section className="still-have-questions-section">
        <div className="still-have-questions-content">
          <h2 className="still-have-questions-title">
            Still Have <span className="still-have-questions-title-highlight">Questions?</span>
          </h2>
          <p className="still-have-questions-subtitle">
            Our investment team is here to help. Contact us directly or express your interest 
