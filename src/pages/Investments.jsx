  ...
  const divisions = [
    {
      ...
      returnsDescription:
        "Asset utilization and leasing income, logistics revenue, asset appreciation",
    },
    {
      id: "sustainable",
      ...
      returnsDescription:
        "Project revenue streams, government incentives, environmental credits",
    },
    {
      id: "alternative",
      ...
      returnsDescription:
        "Asset appreciation, secured lending returns, trade-based profits",
    },
  ];
  ...
  const investmentHighlights = [
    {
      ...
      description:
        "Minimum investments range from USD 25,000 to USD 100,000 depending on division.",
    },
    {
      icon: <Building className="w-6 h-6" />,
      title: "Asset-Backed Focus",
      description:
        "Every program is supported by tangible assets, contractual revenue, or secured structures.",
    },
    {
      icon: <FileText className="w-6 h-6" />,
      title: "Defined Investment Terms",
      description:
        "Lock-in periods, exit rules, and settlement processes are outlined upfront.",
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Capital Protection Framework",
      description:
        "Multi-layered protection measures across all investment programs.",
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Professional Governance",
      description:
        "Structured oversight, compliance standards, and transparent reporting.",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Investor Partnership",
      description:
        "Long-term alignment with investor interests and objectives.",
    },
  ];
        ...
        <div className="investments-hero-content">
          <div className="investments-hero-text-container">
            ...
            <p className="investments-hero-description">
              Three distinct investment arms designed to provide access to
              structured, asset-backed opportunities across multiple sectors.
              Each division follows defined investment terms, disciplined
              deployment, and a focus on capital protection.
            </p>
        ...
        <div className="why-invest-content">
          <div className="section-header">
            <h2 className="section-title">
              ...
              <span className="accent">Practical Structures.</span>
            </h2>
            <p className="section-subtitle">
              HBC combines institutional investment discipline with pragmatic
              execution, offering qualified investors access to non-traditional
              opportunities through clear structures and defined risk
              frameworks.
            </p>
          </div>
                  ...
                  <div className="details-grid">
                    <div className="detail-card">
                      ...
                      <div className="detail-content">
                        ...
                        <span className="detail-value">
                          {division.details.minInvestment}
                        </span>
                      </div>
                    </div>
                    <div className="detail-card">
                    ...
                    <div className="detail-card">
                      ...
                      <div className="detail-content">
                        ...
                        <span className="detail-value returns">
                          {division.details.targetReturns}
                        </span>
                      </div>
                    </div>
                    <div className="detail-card">
                ...
                <div className="structure-section">
                  ...
                  <div className="structure-content">
                    ...
                    <div className="returns-info">
                      ...
                      <span className="returns-label">
                        Returns may include: {division.returnsDescription}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <div className="risk-disclaimer-content">
          ...
          <div className="risk-disclaimer-body">
            <p className="risk-text">
              ...
              performance and current market conditions and are not guaranteed.
              Past performance is not indicative of future results.
            </p>
            <p className="risk-text">
              The information provided does not constitute financial, legal, or
              tax advice. Investors should carefully review all offering
              materials and consult qualified advisors before making any
              investment decision. Investment opportunities are suitable only
              for investors who can afford to bear the risk of loss.
            </p>
          </div>
        </div>
      </section>
