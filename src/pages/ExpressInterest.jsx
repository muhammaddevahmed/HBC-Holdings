...
export default function ExpressInterest() {
  ...
  const investmentDivisions = [
    ...
    { value: 'diversified', label: 'Diversified Portfolio (Multiple Divisions)' },
  ...
  const validateForm = () => {
    ...
    if (!formData.investmentInterest) newErrors.investmentInterest = 'Investment interest is required';
  ...
  if (submitted) {
    return (
      <Layout activePage="/express-interest">
          ...
          <div className="submitted-content">
            <Card className="submitted-card">
              <CardBody className="submitted-card-body">
                ...
                <h2 className="submitted-title">Thank You for Your Interest!</h2>
                <p className="submitted-subtitle">
                  Your expression of interest has been successfully submitted.
                </p>
                <p className="submitted-text">
                  Our investment team will review your information and contact you within 48 business hours 
                  to discuss available opportunities and next steps in the investor onboarding process.
                </p>
                <div className="next-steps-box">
                  <p className="next-steps-text">
                    <strong>What happens next:</strong> You will receive a confirmation email shortly. 
                    A member of our team will reach out to schedule a confidential consultation to discuss 
                    your investment objectives and answer any questions you may have.
                  </p>
                </div>
        ...
        <div className="hero-content">
          <div className="hero-text-container">
            <h1 className="hero-title">
              Express Your <span className="hero-title-highlight">Investment Interest</span>
            </h1>
            <p className="hero-description">
              Begin your journey with HBC Holdings. Complete the form below and our team will contact you 
              to discuss investment opportunities tailored to your objectives.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="trust-signals-content">
          <div className="trust-signals-grid">
            ...
            <div>
              ...
              <p className="trust-signal-description">
                All investor information is kept strictly confidential and never shared
              </p>
            </div>
            <div>
              ...
              <p className="trust-signal-description">
                Expressing interest does not create any investment obligation or commitment
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="form-section">
        <div className="form-content">
          <Card>
            <CardHeader>
              ...
              <p className="form-description">
                Please provide accurate information so we can better understand your investment needs. 
            ...
            <CardBody>
              <form onSubmit={handleSubmit} className="form-container">
                ...
                <div className="gdpr-consent-container">
                  <label className="gdpr-consent-label">
                    ...
                    <span className="gdpr-consent-text">
                      I agree to the <a href="/investor-hub#privacy" className="gdpr-consent-link">Privacy Policy</a> and 
                      consent to HBC Holdings collecting and processing my personal information for the purpose of 
                      evaluating my investment interest. I understand that I can withdraw consent at any time. *
                    </span>
                  </label>
                  {errors.gdprConsent && (
                ...
                <p className="form-recaptcha">
                  ...
                  By submitting this form, you acknowledge that you are a real person expressing genuine investment interest.
                </p>
              </form>
            </CardBody>
          </Card>
          ...
          <div className="info-notice">
            <h5 className="info-notice-title">What Happens After You Submit?</h5>
            <ul className="info-notice-list">
              <li className="info-notice-list-item">
                <span className="info-notice-list-item-bullet">•</span>
                <span>You'll receive an immediate confirmation email acknowledging your submission</span>
              </li>
              <li className="info-notice-list-item">
                <span className="info-notice-list-item-bullet">•</span>
                <span>Our investment team will review your information within 48 business hours</span>
              </li>
              <li className="info-notice-list-item">
                <span className="info-notice-list-item-bullet">•</span>
                <span>We'll schedule a confidential consultation to discuss your investment objectives</span>
              </li>
              <li className="info-notice-list-item">
                <span className="info-notice-list-item-bullet">•</span>
                <span>If qualified, you'll receive detailed investment materials and begin the onboarding process</span>
              </li>
            </ul>
          </div>
        </div>
