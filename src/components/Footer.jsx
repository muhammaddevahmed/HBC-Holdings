        ...
        <div className="footer-grid">
          ...
          <div className="footer-company-info">
            <div className="footer-logo-container">
              <Link to="/" className="footer-logo">
                <img src="/footerlogo.png" alt="HBC Logo" />
              </Link>
            </div>
            <p className="footer-company-description">
              HBC is a private investment firm focused on structured,
              asset-backed investment programs designed to balance capital
              preservation with long-term growth for qualified investors.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="footer-links">
              ...
              <Link to="/investor-hub" className="footer-link">
                Investor Resources
              </Link>
          ...
          <div>
            ...
            <div className="footer-links">
              <a href="/investments#mobility" className="footer-link">
                Mobility Investment Series
              </a>
              <a href="/investments#sustainable" className="footer-link">
                Sustainable & Eco-Investment Series
              </a>
              <a href="/investments#alternative" className="footer-link">
          ...
          <div>
            ...
            <div className="footer-links">
              ...
              <Link to="/investor" className="footer-link">
                FAQ & Testimonials
              </Link>
        ...
        <div className="footer-middle-section">
          <div className="footer-get-in-touch">
            ...
            <div className="footer-links">
              ...
              <Link to="/express-interest" className="footer-link">
                Express Interest
              </Link>
              <a href="mailto:careers@hbcholdings.com" className="footer-link">
                Email
              </a>
          ...
          <div className="footer-social-newsletter">
            ...
            <div className="newsletter-signup">
              ...
              <p>
                Receive market insights, investment updates, and regulatory
                notices from HBC.
              </p>
              <form>
        ...
        <div className="footer-bottom">
          ...
          <div className="legal-disclaimer">
            ...
            <p>
              ...
              capital. Past performance is not indicative of future results. The
              information provided on this website is for informational purposes
              only and does not constitute investment, legal, or tax advice.
              Prospective investors should conduct independent due diligence and
              consult qualified advisors before making any investment decision.
            </p>
          </div>
        </div>
      </div>
